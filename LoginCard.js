    ...
    return (
        <Box sx={{ boxShadow: 10 }} style={{ width: 375, height: 375, zIndex: 10, borderRadius: 5, position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", backgroundColor: "rgba(255,255,255,0.2)", backdropFilter: "blur(4px)" }}>
            <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <Button onClick={authenticateUser} variant="contained" style={{ marginTop: "auto", marginBottom: "18px", width: "70%", textTransform: "none", background: "linear-gradient(45deg, #4EDEE5, #005DAA)" }}>
                    Login
                </Button>
                <Typography variant="caption" style={{ paddingBottom: "18px" }}>
                    Don't have an account? <a style={{ color: "#4EDEE5" }} href="/newUser">Create one</a> today!
                </Typography>
            </div>
